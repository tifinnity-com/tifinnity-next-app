...
export default function Header() {
  ...
  return (
    <header className="relative flex items-center justify-between px-4 py-4 md:px-6 max-w-7xl mx-auto">
      <div className="flex items-center gap-2">
        <div className="w-8 h-8 bg-tifinnity-green rounded flex items-center justify-center">
          <ChefHat className="w-5 h-5 text-white" />
        </div>
        <div>
          <h1 className="text-xl font-bold text-tifinnity-green">Tiffinity</h1>
