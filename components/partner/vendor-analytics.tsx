...
export default function VendorAnalytics() {
  ...
  return (
    <div className="min-h-screen max-w-7xl mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-tifinnity-green">
          Vendor Dashboard
        </h1>
        <p className="text-tifinnity-gray">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card className="bg-white border-tifinnity-green shadow-md">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg text-tifinnity-green">
              Total Profit
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-tifinnity-green">
              ₹72,100
            </div>
            <p className="text-xs text-tifinnity-gray mt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <Card className="bg-white border-tifinnity-green shadow-md">
          <CardHeader>
            <CardTitle className="text-tifinnity-green">
          ...
          <CardContent>
            <div className="h-80 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-tifinnity-gray mb-4">
                  Overall growth in profit compared to last period
                </p>
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-3 bg-secondary rounded-lg">
                    <p className="text-sm text-tifinnity-green">Order Growth</p>
                    <p className="text-lg font-bold text-tifinnity-green">
                      +8.3%
                    </p>
                  </div>
                  <div className="p-3 bg-secondary rounded-lg">
                    <p className="text-sm text-tifinnity-green">
                      Margin Growth
                    </p>
                    <p className="text-lg font-bold text-tifinnity-green">
                      +2.1%
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              {paymentMethodData.map((method, index) => (
                <div key={index} className="flex justify-between items-center">
                  <div className="flex-1">
                    <p className="font-medium text-tifinnity-green">
                      {method.name}
                    </p>
                  </div>
                  <div className="text-tifinnity-green font-bold">
                    {method.value}%
                  </div>
                </div>
              ))}
        ...
        <Card className="bg-white border-tifinnity-green shadow-md">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-3 bg-secondary rounded-lg">
                <p className="text-tifinnity-green font-medium">
              ...
              <div className="p-3 bg-secondary rounded-lg">
                ...
                <p className="text-xl font-bold text-tifinnity-green">
                  12-2 PM
                </p>
              </div>
              <div className="p-3 bg-secondary rounded-lg">
              ...
              <tbody>
                {profitData.map((month, index) => (
                  <tr key={index} className="border-b hover:bg-secondary">
                    ...
                    <td className="px-4 py-3 font-bold text-tifinnity-green">
                      ₹{month.profit.toLocaleString()}
                    </td>
                    <td className="px-4 py-3">
                      {((month.profit / (month.profit / 0.285)) * 100).toFixed(
                        1
                      )}
                      %
                    </td>
                    <td className="px-4 py-3">
                      <span
                        className={`${
                          index > 0 &&
                          month.profit > profitData[index - 1].profit
                            ? "text-green-600"
                            : "text-red-600"
                        }`}
                      >
